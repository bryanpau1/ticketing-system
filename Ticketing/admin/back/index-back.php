...
<div class="card">
  <div class="card-header" data-background-color="blue">
      ...
      <div class="card-content table-responsive">
        <a id="add" class="btn btn-primary" ><span class="glyphicon glyphicon-plus"></span> New User </a> </div>

    <input type="text" ng-model="search" class="form-control" placeholder="Search">
      <table class="table table-bordered table-striped" style="margin-top:10px;">
      <tr>
                        <th ng-click="sort('id')">User ID
                        ...
                        <th ng-click="sort('password')">Password
                          <span class="pull-right">
                            <i class="fa fa-sort gray" ng-show="sortKey!='password'"></i>
                            <i class="fa fa-sort" ng-show="sortKey=='password'" ng-class="{'fa fa-sort-asc':reverse,'fa fa-sort-desc':!reverse}"></i>
                          </span>
                        </th>
