            ...
            <div class="modal-content">
				...
				<form id="addForm">
					<div class="row">
						...
						<div class="col-md-10">
							<input type="text" class="form-control" name="department_name" id="department_name" placeholder="Support">
						</div>
					</div>
            ...
            <div class="modal-content">
                ...
                <form id="editForm">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="edepartment_name" id="edepartment_name">
                        </div>
                    </div>
                    <div style="height:10px;"></div>
                    <div class="row">
    ...
    <div class="modal fade" id="delmem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <div class="container-fluid">
                    <h5><center>Name: <strong><span id="ddepartment_name"></span></strong></center></h5> 
                </div> 
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
